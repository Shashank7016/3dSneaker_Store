...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] relative">
      ...
      {/* ===== Footer ===== */}
      <footer className="bg-[#fafafa] border-t border-gray-100 relative overflow-hidden">
        {/* Subtle glow */}
        <div className="absolute top-0 left-1/3 w-96 h-96 bg-indigo-100/20 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-72 h-72 bg-violet-100/15 rounded-full blur-3xl" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="pt-16 pb-12 grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8">
            ...
            <div className="md:col-span-5">
              <Link href="/" className="flex items-center space-x-2.5 group mb-5">
                <div className="w-8 h-8 bg-gray-900 rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform duration-200">
                  <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
              ...
              <p className="text-sm text-gray-400 leading-relaxed max-w-xs mb-6">
                Design footwear that&apos;s uniquely yours. Every color, every material, every detail — crafted to tell your story.
              </p>
              {/* Social links */}
              <div className="flex gap-3">
                {[
                  ...
                  <a key={i} href="#" className="w-9 h-9 bg-gray-100 rounded-lg flex items-center justify-center hover:bg-gray-200 transition-colors duration-200" aria-label={social.label}>
            ...
            <div className="md:col-span-7 grid grid-cols-3 gap-8">
              <div>
                ...
                <ul className="space-y-2.5">
                  {["Collection", "New Arrivals", "Customize", "Gift Cards"].map((item) => (
                    <li key={item}>
                      <Link href="/store" className="text-sm text-gray-500 hover:text-gray-900 transition-colors duration-200">{item}</Link>
                    </li>
                  ))}
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2.5">
                  {["About", "Careers", "Press", "Blog"].map((item) => (
                    <li key={item}>
                      <a href="#" className="text-sm text-gray-500 hover:text-gray-900 transition-colors duration-200">{item}</a>
                    </li>
                  ))}
                </ul>
              </div>
              <div>
                <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-4">Support</h4>
                <ul className="space-y-2.5">
          ...
          {/* Bottom bar */}
          <div className="border-t border-gray-200/60 py-6 flex flex-col sm:flex-row justify-between items-center gap-3">
            <p className="text-xs text-gray-400">
              &copy; 2025 Forma. All rights reserved.
            </p>
            <div className="flex gap-6">
              {["Privacy", "Terms", "Cookies"].map((link) => (
                <a key={link} href="#" className="text-xs text-gray-400 hover:text-gray-600 transition-colors duration-200">{link}</a>
              ))}
            </div>
          </div>
        </div>
